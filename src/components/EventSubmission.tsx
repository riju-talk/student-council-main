      ...
      <div className="container px-4">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-16">
            <Badge variant="outline" className="mb-4 px-4 py-2 border-text-primary text-primary bg-primary/10 animate-fade-in-down">
              <FileText className="h-3 w-3 mr-2 text-primary" />
              Event Portal
            </Badge>
            <h2 className="text-3xl md:text-4xl font-bold mb-6 text-primary animate-fade-in-up animate-delay-200">Submit Your Event Proposal</h2>
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto text-muted-foreground animate-fade-in-up animate-delay-400">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
            {steps.map((step, index) => {
              ...
              return (
                ...
                >
                  <div className="flex items-center justify-center w-16 h-16 bg-primary/10 rounded-full mb-4 mx-auto animate-gentle-float">
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            {/* Requirements */}
            <div>
              <h3 className="text-2xl font-bold mb-6 animate-fade-in-up animate-delay-500">What You'll Need</h3>
              <Card className="p-6 hover-lift animate-fade-in-scale animate-delay-300">
                <ul className="space-y-3">
                  {requirements.map((requirement, index) => (
                    <li key={index} className="flex items-start animate-fade-in-up" style={{ animationDelay: `${700 + index * 100}ms` }}>
            ...
            {/* CTA Section */}
            <div>
              <h3 className="text-2xl font-bold mb-6 animate-fade-in-up animate-delay-500">Ready to Start?</h3>
              <Card className="p-6 text-center hover-lift animate-fade-in-scale animate-delay-400">
                <div className="mb-6">
                  <div className="w-20 h-20 bg-primary/10 rounded-full flex items-center justify-center mx-auto mb-4 animate-gentle-float">
